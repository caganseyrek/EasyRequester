class Logger {
     ...
     * @returns {void}
     */
    static info(location, debugMessage) {
        if (this.isDebugMode) {
...
class Generator {
    ...
    static generateURL(generateURLParams) {
        ...
        const queryString = generateURLParams.query
...
class BaseRequester {
    ...
    constructor(clientConfig) {
        this.clientConfig = {
            ...
            acceptStatusCodes: Array.from(new Set([...this.POSSIBLE_STATUS_CODES, ...(clientConfig.acceptStatusCodes ?? [])])),
